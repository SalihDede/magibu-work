...
from Ders1.single_letter_transformers.qwen3_5.block import TransformerBlock
from Ders1.single_letter_transformers.qwen3_5.rotary import precompute_cos_sin
